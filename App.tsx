...
import { DEFAULT_CONFIG, SALES_QUALITY_SHEET_URL, SALES_CLAIMS_SHEET_URL, AREAS } from './constants';
...
function App() {
  ...
  const [isGloballyAuthenticated, setIsGloballyAuthenticated] = useState(() => {
    // If not protected, always authenticated
    ...
    <>
      ...
      {reportConfig && (
        <FullReportPrintView 
            ...
            sheetUrls={{
                salesQuality: SALES_QUALITY_SHEET_URL,
                salesClaims: SALES_CLAIMS_SHEET_URL,
